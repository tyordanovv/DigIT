...
function AboutField(){
    return(
        <div className="relative bg-neutral-50 md:p-0">
			...
			">
                <div className="flex justify-center gap-2 items-center mb-6 absolute left-0 top-0 p-6 select-none">
                ...
                <div className="flex flex-col content-start md:flex-row flex-wrap gap-10 justify-center items-center md:px-2 md:min-h-[35vh] ">
                    <AboutCard 
                    title={"01 - Who are we"} 
                    text={"We are DigID. asdas dasasa asdd asdfafa sf a fa fafsfasfas asf atr q g b w eg  tqsfasfaqwr."}
                    />
                    <AboutCard 
                    title={"02 - What we do"} 
                    text={"we do softweareWe are DigID. asdas dasasa asdd asdfafa sf a fa fafsfasfas asf atr q g b w eg  tqsfasfaqwr."}
                    />
                    <AboutCard 
                    title={"03 - Why us"} 
                    text={"cuz we need money We are DigID. asdas dasasa asdd asdfafa sf a fa fafsfasfas asf atr q g b w eg  tqsfasfaqwr."}
                    />
                </div>
            </div>
        </div>
